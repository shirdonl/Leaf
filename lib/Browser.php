...
class Browser implements LeafClientInterface
{
    /** @var LeafClientInterface */
    private $client;
     ...
     */
    public function __construct(LeafClientInterface $client, $requestFactory)
    {
    ...
    public function getClient(): LeafClientInterface
    {
        return $this->client;
    }
